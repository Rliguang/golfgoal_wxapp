<template>
	<view class="c-progress">
		<view class="c-progress-outer" :style="setProgressBgStyle" ref="progress">
			<view class="c-progress-inner" :style="setProgressStyle"></view>
			<view v-show="showSlider" class="c-progress-slider" ref="slider" :style="setSliderStyle"></view>
		</view>
		<span v-show="showPerText">{{tempPercent}}%</span>
	</view>
</template>
